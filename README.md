...
1. [teenager] 文件适配wekf改造，适用于快速初始化Page.js文件

> 优势：专注于Page.js文件中，避免到处Copy文件内容，再删除逻辑的繁琐过程

操作:
- Page文件中的 .js 文件： 打开.js文件 -> 右键打开菜单 -> [teenager]格式化Page文件
- App文件中的 app.js 文件: 打开app.js文件 -> 右键打开菜单 -> [teenager]格式化App文件
<br/>
...
4. [小程序] navigation路径跳转，支持 .js、.wxml、.json 文件
...
6. [小程序] 添加当前页面编译条件至project.config.json
